...
const GLTF_PBR_ONLY_UNIFORM_TYPES = {
  ...
  uGltfOcclusionMap: 'sampler2D',
  uGltfHasOcclusionMap: 'bool',
  uGltfOcclusionUvChannel: 'int',
  uGltfOcclusionUvTransform: 'mat3',
  uGltfOcclusionStrength: 'float',
  uGltfEmissiveMap: 'sampler2D',
  uGltfHasEmissiveMap: 'bool',
  uGltfEmissiveUvChannel: 'int',
  uGltfEmissiveUvTransform: 'mat3',
  uGltfEmissiveFactor: 'vec3',
  uGltfEmissiveIntensity: 'float',
