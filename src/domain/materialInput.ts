...
export const GLTF_PBR_CONTRACT_IDENTIFIERS = [
  ...
  'uGltfNormalScale',
  'uGltfOcclusionMap',
  'uGltfHasOcclusionMap',
  'uGltfOcclusionUvChannel',
  'uGltfOcclusionUvTransform',
  'uGltfOcclusionStrength',
  'uGltfEmissiveMap',
  'uGltfHasEmissiveMap',
  'uGltfEmissiveUvChannel',
  'uGltfEmissiveUvTransform',
  'uGltfEmissiveFactor',
  'uGltfEmissiveIntensity',
  'uEnvironmentMap',
